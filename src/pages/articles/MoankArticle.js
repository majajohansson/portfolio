...
export default ({ match }) => (
  <Page match={match}>
    ...
    <p className="post__paragraph">The sign up flow had one main problem: its inconsistency with the rest of the website. It was also quite long to finish because it was composed of 4 different steps which led to a high drop off rate.</p>
    ...
    <p className="post__paragraph">In the previous version, the steps were shown as Step 1 - Step 4. Following the minimalistic approach, I replaced them with dots instead. It gives the same amount of information to the customer, while not taking his attention as much to let him focus more on the form.</p>
