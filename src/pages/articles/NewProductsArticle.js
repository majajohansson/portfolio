...
const NewProductsArticle = ({ match }) => (
  <Page match={match}>
    ...
    <StyledPost>
      ...
      <StyledParagraph>We began with doing product research and competitor analysis. To study the potential market, I conducted early user interviews and desirability tests. I wanted to learn the needs for a product like this, as well as the pain points with already existing ones. During the research phase we got to know our potential target groups better and how we could improve their everyday life.</StyledParagraph>
